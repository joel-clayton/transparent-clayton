...
from src.constants import CC_MTG_FILE_STUB, CC_MTG_FILE_TEMPLATE, DOWNLOADED_CC_MTG_KEY, AUDIO_EXTRACTED_CC_MTG_KEY, \
...
job_redis_keys = {
    ...
    JobType.EXTRACT_AUDIO: AUDIO_EXTRACTED_CC_MTG_KEY,
