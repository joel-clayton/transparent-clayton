...
from src.types import JobType, SourceType, source_file_templates, job_file_formats, job_paths
...
class Processor:
    ...
    def __init__(self, input_dir: str | None, output_dir: str, job_type: JobType, source_type: SourceType, redis_key: str):
    ...
    def construct_filename_for_date(self, date) -> str:
    ...
    def construct_filepath_for_date(self, date) -> str:
        file_name = self.construct_filename_for_date(date)
        dir_path = job_paths.get[self.job_type]
